          ...
          <div className="content">
            <div className="section">
              ...
              <p className="body-text">
                ...
                and conditions by which you may access zomi.finance ("the Site") and app.zomi.finance ("the
                  ...
                  <ul className="list-style-none">
                    ...
                    <li>
                      <p className="body-text">
                        ...
                        administrative authority having jurisdiction over zomi.finance or you as otherwise duly
                  ...
                  <ul className="list-style-none">
                    <li>
                      <p className="body-text">
                        ...
                        procedures or repairs that zomi.finance or any of its suppliers or contractors may undertake
                        from time to time; (c) causes beyond zomi.finance's control or that zomi.finance could not
                    ...
                    <li>
                      <p className="body-text">
                        ...
                        transaction with zomi.finance;
                      </p>
                    </li>
                    <li>
                      <p className="body-text">1.2.5. zomi.finance does not act as a broker or advisor for you;</p>
                    </li>
                    <li>
                      <p className="body-text">
            ...
            <div className="section">
              ...
              <p className="body-text">
                ...
                fees. zomi.finance does not receive fees for any blockchain transactions or using the Site or the
                Interface.
              </p>
            </div>
            <div className="section">
            ...
            <div className="section">
              ...
              <ul className="list-style-none">
                ...
                <li>
                  <p className="body-text">
                    4.2. zomi.finance may use and share your comments, bug reports, ideas, or other feedback that you
                    may provide, including suggestions about how we might improve. You agree that zomi.finance is
            ...
            <div className="section">
              ...
              <ul className="list-style-none">
                <li>
                  <p className="body-text">
                    5.1. zomi.finance reserve the right, at our sole discretion, from time to time and with or
                    ...
                    do not host or own its code. zomi.finance will not be liable for any losses suffered by you
                ...
                <li>
                  <p className="body-text">
                    5.2. zomi.finance may revise these Terms from time to time. We will notify you by updating the
                    date at the top of the Terms and maintaining a current version. The most current version of the
                    Terms will always be at /terms-and-conditions. All modifications will
                    be effective when they are posted. By continuing to access or use the Site or the Interface after
              ...
              <ul className="list-style-none">
                <li>
                  <p className="body-text">
                    ...
                    others, entails a risk that by accessing transactions, you are assuming. zomi.finance does not
                  ...
                  <ul className="list-style-none">
                    <li>
                      <p className="body-text">
                        6.1.1. That zomi.finance is not responsible for the operation of the open-source software and
                    ...
                    <li>
                      <p className="body-text">
                        ...
                        blockchain-based network. Neither zomi.finance nor any other person or entity will be able to
                ...
                <li>
                  <p className="body-text">
                    6.2. zomi.finance is not responsible for the content of any third party, including, but not
                    limited to, information, materials, products, or services that zomi.finance does not own or
                    control. In addition, third parties may offer promotions related to your access and use of the
                    Interface. zomi.finance does not endorse or assume any responsibility for such resources or
                    ...
                    relationships with any third parties. You expressly relieve zomi.finance of all liability arising
                ...
                <li>
                  <p className="body-text">
                    6.6. You hereby assume and agree that zomi.finance will have no responsibility or liability for
                    the risks in Section 9. You hereby irrevocably waive, release and discharge all claims, whether
                    known or unknown to you, against zomi.finance, its affiliates, and their respective shareholders,
                  ...
                  <ul className="list-style-none">
                    ...
                    <li>
                      <p className="body-text">
                        ...
                        right of publicity, privacy, or any other proprietary right of zomi.finance;
                      </p>
                    </li>
                    <li>
                      <p className="body-text">
                    ...
                    <li>
                      <p className="body-text">
                        7.1.6. Harass, abuse, or harm another person or entity, including zomi.finance's collaborator
            ...
            <div className="section">
              ...
              <p className="body-text">
                You understand that zomi.finance is not registered or licensed by any regulatory agency or authority.
              ...
              <p className="body-text">
                ...
                zomi.finance makes no guarantees of any kind or connection with the Site or the Interface.
              </p>
            </div>
            <div className="section">
              <h3 className="body-title">9. LIMITATION OF LIABILITY</h3>
              <p className="body-text">
                In no event shall zomi.finance, its affiliates, its suppliers and contractors, and its affiliates',
                ...
                or the Interface, or other item provided by or on behalf of zomi.finance, whether under contract,
                ...
                Terms or any limited remedy hereunder nor is zomi.finance in any way responsible for the execution or
                settlement of transactions between users of the Interface.
              </p>
              <p className="body-text">
                In no event shall zomi.finance's aggregate liability arising out of or in connection with the Site or
            ...
            <div className="section">
              ...
              <p className="body-text">
                You will defend, indemnify, and hold harmless zomi.finance, its affiliates, members, member,
            ...
            <div className="section">
              ...
              <p className="body-text">
                zomi.finance will use its best efforts to resolve potential disputes through informal, good faith
                negotiations. If a potential dispute arises, you must contact us by sending a written notice of your
                claim ("Notice") to zomi.finance on any of our official channels. The notice must (a) describe the
                nature and basis of the claim and (b) set forth the specific relief sought. Our notice to you will be
                similar in form to that described above. If you and zomi.finance cannot reach an agreement to resolve
                the claim within sixty (60) days of your email, then you and zomi.finance agree to resolve the
              ...
              <p className="body-text">
                ...
                zomi.finance will not have the right to assert the claim.
              </p>
            </div>
            <div className="section">
            ...
            <div className="section">
              ...
              <ul className="list-style-none">
                <li>
                  <p className="body-text">
                    13.1. Any right or remedy of zomi.finance set forth in these Terms is in addition to, and not in
                    lieu of, any other right or remedy whether described in these Terms, under Applicable Law, at law,
                    or in equity. The failure or delay of zomi.finance in exercising any right, power, or privilege
                ...
                <li>
                  <p className="body-text">
                    13.4. zomi.finance will have no responsibility or liability for any failure or delay in
                ...
                <li>
                  <p className="body-text">
                    13.6. These Terms contain the entire agreement between you and zomi.finance and supersede all
            ...
            <div className="section">
              ...
              <p className="body-text">
                ...
                zomi.finance on any of our official channels.
              </p>
            </div>
          </div>
        </div>
