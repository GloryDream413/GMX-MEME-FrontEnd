      ...
      <div className="default-container Page page-layout">
        <div>
          <div className="Page-title-section center">
            <div className="Page-title">$ZOMI Referral Program</div>
          ...
          <div className="content">
            <div className="section">
              ...
              <p className="body-text">
                ...
                Affiliate"), explains the terms and conditions by which you may use the $ZOMI Referral Program
            ...
            <div className="section">
              ...
              <p className="body-text">
                The Referral Program allows you to advertise the $ZOMI DApp, thereby driving traffic to it, whereby you
                may earn a portion of the fees generated ("Rebates") if a person that is not you ("Trader," "Referred
                User") trades in the $ZOMI DApp after being referred to it from a hyperlink ("Link") or manually input
                code ("Referral Code"). The Trader will benefit from a fee discount ("Discount") associated with the
                Referrer's tier.
              </p>
              <p className="body-text">
                After being referred to the $ZOMI DApp from a Link, the Trader's browser will save your Referral Code,
            ...
            <div className="section">
              ...
              <p className="body-text">
                2.1 As an Affiliate, $ZOMI DApp provides you with the Links and Referral Codes necessary to promote the
                $ZOMI Protocol. You acknowledge and agree it is your sole responsibility to indicate your correct
                Referral Code. You may promote the $ZOMI Protocol offers in any manner you choose unless it misleads
                someone about the $ZOMI Protocol.
              </p>
              <p className="body-text">
              ...
              <p className="body-text">
                2.3 You will be excluded from the Referral Program, following the directives of the $ZOMI tokenholders:
            ...
            <div className="section">
              ...
              <p className="body-text">
                ...
                Discounts are handled following the directives of the $ZOMI tokenholders.
              </p>
              <p className="body-text">
            ...
            <div className="section">
              ...
              <p className="body-text">
                The Referral Program runs independently from zomi.finance, which the token holders of $ZOMI
